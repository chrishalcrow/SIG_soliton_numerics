...
make will have many good practices built into it: tests, documentation. It'll be readable, 
reproducible and published openly on GitHub. With this structure, I hope you can use this 
project as a base for future work.

So that everyone has the same experience, we'll be using Python. If you'd prefer to use a 
different language, go for it, but I won't be able to help to easily. C++, Julia and Matlab 
...
Jupyter notebook. To use it, we need to add another package to our package. In the 
