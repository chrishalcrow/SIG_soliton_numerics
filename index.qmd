...
To run the test suit we need to add `pytest` to our package by running `uv add pytest` in Terminal, while 
`cd`d in the project. Then we can run `uv run pytest`. I get the following output:
